...
public extension Model {
  ...
  func executeQuery(query: Query, parameters: [Any?], using db: Database? = nil, _ onCompletion: @escaping (Self?, RequestError?) -> Void ) {
    var connection: Connection
    do {
      connection = try Self.getConnection(using: db)
    } catch let error {
  ...
  func executeQuery<I: Identifier>(query: Query, parameters: [Any?], using db: Database? = nil, _ onCompletion: @escaping (I?, Self?, RequestError?) -> Void ) {
